...
254	300	0	三姐姐	新年红包	2022-02-06 20:35:55.986983+08	4
\.
...
2	t	t	t	2018-12-21	2022-01-30	2	5000	80000
1	t	t	t	2018-12-20	2022-02-04	1	4000	60000
\.
...
SELECT pg_catalog.setval('public.iaer_iaer_id_seq', 4459, true);
...
SELECT pg_catalog.setval('public.iaer_redenvelope_id_seq', 254, true);
